...
# dynamic link library (.so) ရှိတဲ့ လမ်းကြောင်းကို ရှာခိုင်းတာပါ
sys.path.append(os.path.dirname(os.path.abspath(__file__)))

# ctypes နေရာမှာ ပုံမှန် import သုံးပြီး ခေါ်ပါမယ်
import yourgod

if __name__ == "__main__":
    # ဒီနေရာမှာ start_menu() သို့မဟုတ် သက်ဆိုင်ရာ function ကို တိုက်ရိုက်ခေါ်ပါ
    import asyncio
    asyncio.run(yourgod.start_menu())
